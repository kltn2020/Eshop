defmodule EshopCore.Utils.DateTime do
  def local_default(datetime \\ nil)

  def local_default(%DateTime{} = datetime) do
    DateTime.shift_zone!(
      datetime,
      EshopCore.Utils.Constants.get_default_timezone(),
  ...
  Example:
    EshopCore.Utils.DateTime.day_begin_of_week(1, 2020) -> result: ~D[2019-12-30]
  """
